...
export const resultOfCalling: { [K in BuiltInValue]: CallGetter } = {
    ...
    'React': uncallable('React'),
    'React.createElement': singleConfig,
    'React.createElement()': uncallable('React.createElement()'),
...
export const resultOfPropertyAccess: { [K in BuiltInValue]: PropertyAccessGetter } = {
    ...
    'Promise.allSettled()': inaccessibleProperty('Promise.allSettled()'),
    'React': builtInStaticMethod('React.createElement'),
    'React.createElement': inaccessibleProperty('React.createElement'),
    'React.createElement()': inaccessibleProperty('React.createElement()'), // TODO
...
export const resultOfElementAccess: { [K in BuiltInValue]: ElementAccessGetter } = {
    ...
    'Promise.allSettled()': inaccessibleElement,
    'React': inaccessibleElement,
    'React.createElement': inaccessibleElement,
    'React.createElement()': inaccessibleElement,
...
export const primopBinderGetters: PrimopBinderGetters = {
    ...
    'Promise.allSettled()': notSupported('Promise.allSettled()'),
    'React': notSupported('React'),
    'React.createElement': notSupported('React.createElement'),
    'React.createElement()': notSupported('React.createElement()'),
